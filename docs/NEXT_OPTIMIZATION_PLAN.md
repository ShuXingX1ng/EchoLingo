...
1. **学习计划功能** — 根据用户水平和目标制定个性化学习计划
2. **发音练习增强** — 音素级反馈、发音对比、常见错误统计
3. **词汇积累** — 自动提取练习中的高级词汇，生成词汇本
4. **AI 对话增强** — 更自然的考官对话、追问策略、话题拓展

### 优先级 2：用户体验优化

1. **历史数据分析** — 学习曲线、进步趋势、薄弱环节可视化
2. **导出功能增强** — PDF 报告、学习记录导出
3. **个性化设置** — 语速偏好、话题偏好、练习时长目标

### 优先级 3：后端功能扩展

1. **用户画像 API** — 基于历史数据的用户能力评估
2. **智能推荐 API** — 基于薄弱项的练习推荐
3. **学习统计 API** — 更丰富的统计数据接口
